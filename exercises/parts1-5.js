...
// console.log(`${spacecraftName} would take ${getDaysToLocation(kilometersToMars)} days to get to Mars and ${getDaysToLocation(kilometersToTheMoon)} to get to the Moon.`);
